...
// Production URL. It powers the sitemap and the canonical URLs in BaseHead.
// If this is deployed as a GitHub project page rather than a user page,
// add `base: '/<repo-name>'` below as well.
const SITE_URL = 'https://00david.github.io';
